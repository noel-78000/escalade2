...
<form action="${pageContext.request.contextPath}/comment/add" method="post">
    ...
    <textarea id="commentnew" name="commentnew" placeholder="<spring:message code="comment.write.your.comment"/>" maxlength="65535"><c:out value="${param.commentnew}"/></textarea>
    <br/>
